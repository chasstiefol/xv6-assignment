...
procdumpP1(struct proc *p, char *state_string)
{
  ...
  if(elapsed % 1000 < 10){
    cprintf("%d.00%d\t%s\t%d\t", elapsed/1000, elapsed%1000, state_string, p->sz);
  }else if(elapsed % 1000 < 100){
    cprintf("%d.0%d\t%s\t%d\t", elapsed/1000, elapsed%1000, state_string, p->sz);
  }else {
    cprintf("%d.%d\t%s\t%d\t", elapsed/1000, elapsed%1000, state_string, p->sz);
  }
  return;
}
#endif
